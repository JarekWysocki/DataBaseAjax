...
if(isset($_POST['toUser']) && isset($_POST['fromUser']) && isset($_POST['value'])) {
  ...
  $value = $_POST['value'];
  $query = $pdo->prepare("SELECT * FROM messages WHERE (to_user_id = '$toUser' or to_user_id = '$fromUser') && (from_user_id = '$fromUser' or from_user_id = '$toUser') ORDER BY id DESC LIMIT $value");
      if ($query ->execute()) {
